...
import jpabook.jpaWeb.repository.OrderSimpleQueryDto;
import lombok.Data;
...
public class OrderSimpleApiController {
    ...
    @GetMapping("/api/v2/simple-orders") //result로 감싸자
    ...
    public List<SimpleOrderDto> ordersV3(){
        List<Order> orders = orderRepository.findAllWithMemberDelivery();//fetchJoin
        return orders.stream()
                .map(o->new SimpleOrderDto(o))
                .collect(Collectors.toList());
    }
